...
<title>设置权限</title>
<link rel="StyleSheet" href="resources/dtree.css" type="text/css" />
<script type="text/javascript" src="resources/dtree.js"></script>
</head>
<body>
	<div class="dtree">
		...
		d.add(9,2,'修改','authorizationSet.jsp','Pictures I\'ve taken over the years','','','resources/img/imgfolder.gif');
		d.add(19,2,'删除','authorizationSet.jsp','Pictures of Gullfoss and Geysir');
		d.add(20,2,'设置权限','authorizationSet.jsp');
		d.add(21,4,'查询','authorizationSet.jsp','','','resources/img/trash.gif');
		d.add(22,4,'重置','authorizationSet.jsp','','','resources/img/trash.gif');
		d.add(23,4,'新增','authorizationSet.jsp','','','resources/img/trash.gif');
		d.add(24,4,'批量删除','authorizationSet.jsp','','','resources/img/trash.gif');
		d.add(25,4,'修改','authorizationSet.jsp','','','resources/img/trash.gif');
		d.add(26,4,'删除','authorizationSet.jsp','','','resources/img/trash.gif');
